...
export const STEP_NARRATIVES: Record<AgentStep, StepNarrative> = {
  extract: {
    ...
    actions: [
      ...
      "Calls NOAH (JSON mode) with a 27-attribute schema hint",
    ...
    systems: [
      "NOAH agent · Ollama @ localhost:11434 (qwen2.5:7b)",
  ...
  risk: {
    ...
    actions: [
      ...
      "scoreLLM() — NOAH qualitative signal on factors not captured by rules (0-40)",
    ...
    handoffTo: "Senior Accountant — validates high-risk contracts. Queue sorts by score desc.",
  },
  techAcct: {
    step: "techAcct",
    ...
    handoffTo: "SG&A Manager — signs off on ASC classifications per SOX.",
  ...
  accrual: {
    ...
    actions: [
      "NOAH extracts fee schedule + service dates as STRINGS (no numeric output permitted)",
    ...
    systems: [
      "NOAH agent · Ollama @ localhost:11434 (qwen2.5:7b) — term extraction only (no numeric output)",
    ...
    handoffTo: "SG&A Manager — one-click Approve → posts to SAP via BlackLine (simulated).",
  ...
  "narrative-variance": {
    ...
    actions: [
      ...
      "NOAH generates 2-3 sentence prose — grounded in supplied numbers only",
    ...
    handoffTo: "Financial Reporting Manager — Copy/Accept; edits as needed.",
  ...
  "narrative-exec": {
    ...
    actions: [
      ...
      "NOAH generates headline + highlights[] + risks[] + recommendation",
    ...
    handoffTo: "VP Controlling — presents to board.",
